...
const ServicesDetailsContent = ({ serviceInfo }) => {
    ...
    return (
        <>
            <div className="services-details-area bg-gray default-padding">
                <div className="container">
                    <div className="services-details-items">
                        <div className="row">
                            <div className="col-12 pr-45 pr-md-15 pr-xs-15 services-single-content">
                            {/* <div className="col-xl-8 col-lg-7 pr-45 pr-md-15 pr-xs-15 services-single-content"> */}
                                ...
                                <p>{text}</p>
                                <div className="features text-light mt-40 mt-xs-30 mb-30 mb-xs-20">
                                    <div className="row">
                                ...
                                <h3 className='text-light'>What we do?</h3>
                                <p>
                                ...
                                <div className="faq-style-one service-faq mt-40">
                                    <h2 className="mb-30 text-light">Questions about service</h2>
                                    <ServiceFaqV1 />
                                </div>
